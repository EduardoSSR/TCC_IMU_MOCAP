...
def main():
    ...
    while(t==0):    
        ...
        command = (input("Digite 0 para intervalo de leitura entre +-250 deg/s;\n Digite 1 para intervalo de leitura entre +-500 deg/s;\n Digite 2 para intervalo de leitura entre +-1000 deg/s;\n Digite 3 para intervalo de leitura entre +-2000 deg/s;\n"))
